...
import williamlopes.cursoandroid.olx.helper.Permissao;
...
public class CadastrarAnuncioActivity extends AppCompatActivity
    ...
    private String[] permissoes = new String[]{ //Array de permissões que só tem a galeria
    ...
    private void salvarFotoStorage(final String urlString, final int totalFotos, int contador){
    ...
    @Override // Assim não precisa criar evento de clique para as 3 imagens, qualquer evento de clique em activity_cadastrar_anuncio será controla por esse método implementado pela interface View.OnClickListener
    ...
    public void escolherImagem(int resquestCode){
        ...
        startActivityForResult( i, resquestCode ); //Abrir galeria
    ...
    private void inicializarComponentes(){
        ...
        campoTelefone = findViewById(R.id.editNumero);
        ...
        imagem1.setOnClickListener(this); //A própria classe vai gerenciar esse clique
        imagem2.setOnClickListener(this); //A própria classe vai gerenciar esse clique
        imagem3.setOnClickListener(this); //A própria classe vai gerenciar esse clique




        //Configura localidade para pt >  português BR
